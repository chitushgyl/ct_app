...
var vm = new Vue({
	...
	methods:{
		...
		getListDataFromNet:function(pageNum){
			console.log(pageNum);
			var self = this;
			...
			request.PostInfo_new(request.api_driver_orderPage,data,function(res){
		...
		vehical_done: function(index,id){//内部订单 完成
			...
			if(id == 132){
				mui.openWindow({
				    url:'../3pl_driver/uploadImg.html',
				    id:'../3pl_driver/uploadImg.html',
				    styles:{},
				    extras:{
				      data:data
				    },
