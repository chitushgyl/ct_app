    ...
    window.keyBoard = function() {
        ...
        function openKeyBoard(notice, initNumber, model, callbackEvery, callbackLast, openCallback, closeCallback) {
            ...
            if(!keyBoardDiv || model !== currModel) {
                ...
                if(keyBoardDiv) {
                    body.removeChild(keyBoardDiv);      // 移除整个键盘区域
                }
            ...
            if(keyBoardClick) {
                keyBoard.removeEventListener("tap", keyBoardClick);
                keyBoardDiv.removeEventListener("tap", keyBoardDivClick);
            ...
            // 注册监听事件
            keyBoard.addEventListener("tap", keyBoardClick, false);
            keyBoardDiv.addEventListener("tap", keyBoardDivClick, false);
