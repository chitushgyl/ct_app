...
var vm = new Vue({
	...
	methods:{
		...
		getTransportData:function(pageNum){
			...
			request.PostInfo_new(request.linePage,data,function(response){
		...
		// 	var self = this;
		// 	mui.openWindow({
		// 	    url:"fixwriteinfo.html",
		// 	    id:"fixwriteinfo.html",
		// 	    extras:{
		// 	    	data:{
		// 	    		start_str: self.vehicalList[index].start_city,
		// 	    		end_str: self.vehicalList[index].end_city,
		// 	    		start_id: self.start_id,
		// 	    		end_id: self.end_id,
		// 	    		hour: self.vehicalList[index].hour,
		// 	    		price:self.vehicalList[index].countprice
		// 	    	}
		// 	    },
		// 	    waiting:{
		...
		// 	})
		// },
		// toCityOrderDetail: function(index){     //前往城配线路下单详情页面
		// 	var self = this;
		// 	mui.openWindow({
		// 	    url:"../cityDelivery/cityDelivery.html",
		// 	    id:"cityDelivery.html",
		// 	    extras:{
		// 	    	city_name : self.cityList[index].start_city,
		// 	    	city_id : self.start_id,
		// 	    	pro_id : self.pro_id
		// 	    },
		// 	    waiting:{
		// 	      	autoShow:true,//自动显示等待框，默认为true
		...
		// 	})
		// },
		// toVehicalCheapOrderDetail: function(index){   //前往特价整车下单详情页面
		// 	var self = this;
		...
		// 		return false;
		// 	}
		// 	var data = self.vehicalList[index];
		// 	var get_id = self.vehicalList[index].id;
			
		// 	mui.openWindow({
		// 		url:"../fullTruck/car.html",
		// 	    id:"../fullTruck/car.html",
		// 	    extras:{
		// 	    	from_:2,
		// 	    	// startcity_str : data.startCity,
