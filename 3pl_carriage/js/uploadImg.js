	...
	methods:{
				submitFun: function(){
					...
					console.log(self.car_id)
						...
						request.PostInfo_new(request.api_carriage_up_receipt,submitData,function(res){
							mui.toast(res.msg);
							console.log(JSON.stringify(res))
							// plus.webview.getWebviewById("3pl_carriage/order_list.html").evalJS('refresh_show()');
...
function getGalleryImage(self,up_type) {
  ...
  function setHtml(path) {
 	 ...
 	 '<img id="travelimg" class="uploadImg" src="'+path+'" ref="rep" style="width: 110px; height: 80px;"/>'+
